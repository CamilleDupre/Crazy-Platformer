...
/**
 * Implementation of the KeyListener interface used to catch the keyboards entries 
 */
    ...
    public void keyPressed(KeyEvent e) {
        switch (e.getKeyCode()) {
            ...
            case KeyEvent.VK_SPACE :
            	...
            	if (!this.control.getModel().isGameOver() && !this.control.getModel().isGamePaused() && !this.control.getModel().isInAir()) {
            		
            		this.sound.playJumpSound();
            		this.control.jump();
            		
            	} else if (this.control.getModel().isGameOver()) {
            		
            		this.control.getModel().resetGame();
            	}
            ...
            case KeyEvent.VK_ESCAPE :
            	...
            	if (!this.control.getModel().isGameOver()) {
                	...
                	if (!this.control.getModel().isGamePaused()) {
                		...
                		this.control.getModel().pauseGame();
                		this.sound.pauseMainTheme();
                		
                	} else {
                		
                		this.control.getModel().resumeGame();
